...
addAttr('combatAttPerc', _('Combat defense (extra)'), V_SEQUIP|V_HULL|V_EFF, 1, convertor = perc2Text)
addAttr('combatDefPerc', _('Combat attack (extra)'), V_SEQUIP|V_HULL|V_EFF, 1, convertor = perc2Text)
addAttr('missileDefPerc', _('Missile defence (extra)'), V_SEQUIP|V_EFF, 1, convertor = perc2Text)
